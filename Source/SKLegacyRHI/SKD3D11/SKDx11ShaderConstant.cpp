...
void SKDX11Renderer::SetUserConstantWorldViewProjectMatrix(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
...
void SKDX11Renderer::SetUserLightShadowMatrix(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
...
void SKDX11Renderer::SetUserConstantWorldViewMatrix(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
...
void SKDX11Renderer::SetUserConstantSkin(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
...
void SKDX11Renderer::SetUserConstantLightWorldPos(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
...
void SKDX11Renderer::SetUserConstantLightWorldDirection(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
...
void SKDX11Renderer::SetMaterialVShaderConstant(MaterialShaderPara &MSPara,unsigned int uiPassType,SKVShader *pVShader)
{
	unsigned int ID = 0;
...
void SKDX11Renderer::SetUserConstantWorldMatrix(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
	SKTransform World = MSPara.pGeometry->GetWorldTransform();
	SKMatrix3X3W  *TempMatrix  = (SKMatrix3X3W  *)pShader->m_pUserConstant[ID]->GetDate();
...
void SKDX11Renderer::SetUserConstantCameraPos(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
	SKVector3 * pCameraPos = (SKVector3 *) pShader->m_pUserConstant[ID]->GetDate();
	*pCameraPos= MSPara.pCamera->GetWorldTranslate();
	ID++;
}
void SKDX11Renderer::SetUserConstantSkyUpColor(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
	SKColorRGBA * pColor = (SKColorRGBA *) pShader->m_pUserConstant[ID]->GetDate();
	*pColor= MSPara.m_SkyLightUpColor;
	ID++;
}
void SKDX11Renderer::SetUserConstantSkyDownColor(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
	SKColorRGBA * pColor = (SKColorRGBA *) pShader->m_pUserConstant[ID]->GetDate();
	*pColor= MSPara.m_SkyLightDownColor;
	ID++;	
}
void SKDX11Renderer::SetUserConstantLight(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
...
void SKDX11Renderer::SetUserConstantLightFuntionSampler(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
	SKArray<SKLight*> & LightArray = MSPara.LightArray;
	for (unsigned int i = 0 ; i < LightArray.GetNum() ; i++)
	{
...
void SKDX11Renderer::SetUserConstantShadowSampler(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
	SKArray<SKLight*> & LightArray = MSPara.LightArray;
	for (unsigned int i = 0 ; i < LightArray.GetNum() ; i++)
	{
...
void SKDX11Renderer::SetUserConstantFarZ(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
	SKREAL  * Temp  = (SKREAL *)pShader->m_pUserConstant[ID]->GetDate();
	*Temp = MSPara.pCamera->GetZFar();	
	ID++;
}
void SKDX11Renderer::SetUserConstantPointLightRange(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
	SKREAL  * Temp  = (SKREAL *)pShader->m_pUserConstant[ID]->GetDate();
...
void SKDX11Renderer::SetUserConstantInvRTWidth(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
	SKREAL  * Temp  = (SKREAL *)pShader->m_pUserConstant[ID]->GetDate();
...
void SKDX11Renderer::SetUserConstantProjectMatrix(MaterialShaderPara &MSPara, SKShader * pShader, unsigned int& ID)
{
	SKMatrix3X3W  *TempMatrix = (SKMatrix3X3W  *)pShader->m_pUserConstant[ID]->GetDate();
	*TempMatrix = MSPara.pCamera->GetProjMatrix();
	ID++;
}
void SKDX11Renderer::SetUserConstantViewMatrix(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
	SKMatrix3X3W  *TempMatrix  = (SKMatrix3X3W  *)pShader->m_pUserConstant[ID]->GetDate();
	*TempMatrix = MSPara.pCamera->GetViewMatrix();
	ID++;
}
void SKDX11Renderer::SetUserConstantViewProjectMatrix(MaterialShaderPara &MSPara,SKShader * pShader,unsigned int& ID)
{
	SKMatrix3X3W  *TempMatrix  = (SKMatrix3X3W  *)pShader->m_pUserConstant[ID]->GetDate();
	*TempMatrix = MSPara.pCamera->GetViewMatrix() * MSPara.pCamera->GetProjMatrix();
	ID++;
}
void SKDX11Renderer::SetMaterialPShaderConstant(MaterialShaderPara &MSPara,unsigned int uiPassType,SKPShader *pPShader)
{
	unsigned int ID = 0;
	if (uiPassType == SKPass::PT_MATERIAL)
	{
