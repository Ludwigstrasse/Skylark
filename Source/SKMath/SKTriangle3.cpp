...
/*----------------------------------------------------------------*/
SKTriangle3::SKTriangle3(const SKVector3 & P0,const SKVector3 &P1,const SKVector3 &P2)
{
	Set(P0,P1,P2);
	
}
/*----------------------------------------------------------------*/
SKTriangle3::SKTriangle3(const SKVector3 Point[3])
{
	Set(Point);
}
/*----------------------------------------------------------------*/
bool SKTriangle3::GetParameter(const SKVector3 &Point,SKREAL fTriangleParameter[3])const
{
	SKVector3 v01, v02,v0p;
	SKVector3 vp1, vp2;
	v01 = m_V[1] - m_V[0];
	v02 = m_V[2] - m_V[0];
	v0p = Point - m_V[0];
...
void SKTriangle3::Transform(const SKTriangle3 & Triangle,const SKMatrix3X3W &Mat)
{
