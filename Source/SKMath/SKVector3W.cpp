...
/*----------------------------------------------------------------*/
SKVector3W::SKVector3W(void) 
{
	x=0, y=0, z=0, w=1.0f; 
}
/*----------------------------------------------------------------*/
SKVector3W::SKVector3W(SKREAL _x, SKREAL _y, SKREAL _z,SKREAL _w)
{
	x=_x; y=_y; z=_z; w=_w; 
}
/*----------------------------------------------------------------*/
SKVector3W::SKVector3W(unsigned char R,unsigned char G,unsigned char B,unsigned char A)
{
	r = (R * (SKREAL)1.0) / 255;
	g = (G * (SKREAL)1.0) / 255;
	b = (B * (SKREAL)1.0) / 255;
...
/*----------------------------------------------------------------*/
SKVector3W::SKVector3W(const SKVector3 & V)
{

	Set(V);
}
/*----------------------------------------------------------------*/
void SKVector3W::CreateFromARGB(DWORD ARGB)
{
	unsigned char a,r,g,b;
	SKDWCOLORGetARGB(ARGB,a,r,g,b);
	*this = SKVector3W(r, g, b, a);
}
void SKVector3W::CreateFromBGRA(DWORD BGRA)
{
	unsigned char a,r,g,b;
	SKDWCOLORGetBGRA(BGRA,a,r,g,b);
	*this = SKVector3W(r,g,b,a);
}
void SKVector3W::CreateFromRGBA(DWORD RGBA)
{
	unsigned char a,r,g,b;
	SKDWCOLORGetRGBA(RGBA,a,r,g,b);
	*this = SKVector3W(r,g,b,a);
}
void SKVector3W::CreateFormABGR(DWORD ABGR)
{
	unsigned char a,r,g,b;
	SKDWCOLORGetABGR(ABGR,a,r,g,b);
	*this = SKVector3W(r,g,b,a);
}
/*----------------------------------------------------------------*/
SKVector3W SKVector3W::operator * (const SKMatrix3X3W &m) const 
{
	SKVector3W vcResult;
...
/*----------------------------------------------------------------*/
void SKVector3W::operator += (const SKVector3W &v)
{
#ifdef SK_SSE
	{
...
/*----------------------------------------------------------------*/
void SKVector3W::operator *= (SKREAL f)
{
#ifdef SK_SSE
	{
		__m128 _v1 = _mm_set_ps(x,y,z,w);
...
/*----------------------------------------------------------------*/
SKVector3W SKVector3W::operator * (SKREAL f)const
{
#ifdef SK_SSE
	{
		__m128 _v1 = _mm_set_ps(x,y,z,w);
		__m128 _v2 = _mm_set_ps(f,f,f,f);
		__m128 _v3 = _mm_mul_ps(_v1,_v2);
		return SKVector3W(_v3.m128_f32[3],_v3.m128_f32[2], _v3.m128_f32[1],_v3.m128_f32[0]);
	}
#else
	{
		return SKVector3W(x*f, y*f, z*f,w*f);
	}
#endif
...
/*----------------------------------------------------------------*/
SKVector3W SKVector3W::operator + (const SKVector3W &v)const
{
#ifdef SK_SSE
	{
		__m128 _v1 = _mm_set_ps(x,y,z,w);
...
#else
	{
		return SKVector3W(x+v.x, y+v.y, z+v.z,w+v.w);
	}
#endif
}
/*----------------------------------------------------------------*/
...
/*----------------------------------------------------------------*/
bool SKVector3W::operator ==(const SKVector3W &v)const
{
...
/*----------------------------------------------------------------*/
DWORD SKVector3W::GetDWARGB()const
{
...
/*----------------------------------------------------------------*/
DWORD SKVector3W::GetDWRGBA()const
{
	unsigned char R,G,B,A;
	GetUCColor(A,R,G,B);
...
/*----------------------------------------------------------------*/
DWORD SKVector3W::GetDWBGRA()const
{
	unsigned char R,G,B,A;
	GetUCColor(A,R,G,B);
...
/*----------------------------------------------------------------*/
DWORD SKVector3W::GetDWABGR()const
{
	unsigned char R,G,B,A;
	GetUCColor(A,R,G,B);
...
/*----------------------------------------------------------------*/
void SKVector3W::GetUCColor(unsigned char &A,unsigned char &R,unsigned char &G,unsigned char &B)const
{
