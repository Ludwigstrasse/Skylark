...
namespace SKEngine2
{
void SKFastMul(const SKMatrix3X3W & InM1,const SKMatrix3X3W & InM2,SKMatrix3X3W & OutM)
{
	__asm
	{
		mov		eax, [InM2]
...
void SKFastAdd(const SKMatrix3X3W & InM1,const SKMatrix3X3W & InM2,SKMatrix3X3W & OutM)
{
	__asm
	{
		mov eax, [InM2];
...
void SKFastSub(const SKMatrix3X3W & InM1,const SKMatrix3X3W & InM2,SKMatrix3X3W & OutM)
{
	__asm
	{
		mov eax, [InM2];
...
void SKFastMul(const SKMatrix3X3W & InM1,SKREAL f,SKMatrix3X3W & OutM)
{
	__asm
	{
		mov ecx, [InM1];
...
void SKFastLerp(const SKMatrix3X3W & InM1,const SKMatrix3X3W & InM2,SKREAL f,SKMatrix3X3W & OutM)
{
	__asm
	{
		mov eax, [InM2];
...
SKREAL SKFastLength(const SKVector2 &vec)
{
	SKREAL rt;
	const SKREAL fThree = 3.0f;
	const SKREAL fOneHalf = 0.5f;
	__asm
	{
		mov ecx, [vec];
		movups xmm0, [ecx];
...
SKREAL SKFastLength(const SKVector3 &vec)
{
	SKREAL rt;
	const SKREAL fThree = 3.0f;
	const SKREAL fOneHalf = 0.5f;
...
SKREAL SKFastLength(const SKVector3W &vec)
{
	SKREAL rt;
	const SKREAL fThree = 3.0f;
	const SKREAL fOneHalf = 0.5f;
...
void SKFastCross(const SKVector3 &InV1, const SKVector3 &InV2,SKVector3 &OutV)
{
	__asm
	{
		mov ecx, [InV1];
...
void SKFastNormalize(const SKVector2 &InV,SKVector2 &OutV)
{
	const SKREAL fThree = 3.0f;
	const SKREAL fOneHalf = 0.5f;
	__asm
...
void SKFastNormalize(const SKVector3 &InV,SKVector3 &OutV)
{
	const SKREAL fThree = 3.0f;
	const SKREAL fOneHalf = 0.5f;
	__asm
...
void SKFastNormalize(const SKVector3W &InV,SKVector3W &OutV)
{
	const SKREAL fThree = 3.0f;
	const SKREAL fOneHalf = 0.5f;
	__asm
