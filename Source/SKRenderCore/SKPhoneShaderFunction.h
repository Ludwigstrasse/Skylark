#ifndef SKPHONESHADERFUNCTION_H
#define SKPHONESHADERFUNCTION_H
#include "SKShaderMainFunction.h"
namespace SKEngine2
{
	// good for plastics
	class SKGRAPHIC_API SKPhoneShaderFunction : public SKShaderMainFunction
	{
		//RTTI
		DECLARE_RTTI;
		//PRIORITY
	...
	public:
		...
		SKPhoneShaderFunction(const SKUsedName & ShowName,SKMaterial * pMaterial);
		virtual ~SKPhoneShaderFunction();
	...
	protected:
		SKPhoneShaderFunction();
		unsigned int m_uiSpecularType;
	DECLARE_INITIAL
	
	};
	DECLARE_Ptr(SKPhoneShaderFunction);
	SKTYPE_MARCO(SKPhoneShaderFunction);
}
#endif