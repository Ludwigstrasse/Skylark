...
SKTimer * SKTimer::ms_pTimer = NULL;
SKTimer::SKTimer()
{
	InitGameTime();
	ms_pTimer = this;
...
{  //ѽеʱ,λ
	...
	{
		return ((timeGetTime() - m_ulTimeStart));  //timeGetTimeصʱ䵥λΪ
	}
}

void SKTimer::UpdateFPS()
{
