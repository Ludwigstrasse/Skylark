...
"%EXE%" > "%LOG_DIR%\run_windows_skylark_cam_workbench_m6_post_processing_validation.log" 2>&1
set "RC=%ERRORLEVEL%"
type "%LOG_DIR%\run_windows_skylark_cam_workbench_m6_post_processing_validation.log"
